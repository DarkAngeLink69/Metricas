...
<%
    ...
    int tipoUsuario = ((Integer) miSesion.getAttribute("tipo_usuario"));
%>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li><a href="MenuDelDia.jsp">Menú del día</a></li>
                    <li><a href="MenuSemanal.jsp">Menú semanal</a></li>
                    <li><a href="Votaciones.jsp">Votaciones</a></li>
